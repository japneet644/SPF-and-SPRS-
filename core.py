...
class Symbol:
    __slots__ = ["index", "degree", "neighbors"] # fixing attributes may reduce memory usage

    def __init__(self, index, degree,neighbors):
        self.index = index
        self.degree = degree
...
def generate_indexes(degree, blocks_quantity):
